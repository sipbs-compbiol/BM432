...
This course material is built up from several components, and mostly written in the programming language [`R`](https://www.r-project.org/about.html), which is widely used in academia and industry for statistical computing and graphics.
...
- `OpenRefine`
  - To engage with the data-cleaning section, you will need `OpenRefine` and a wev browser. This is a `Java` program that runs on your machine (not in the cloud) and, although it runs in a web browser, no web connection is needed.
- `git` 
...
The material for this repository is held at `GitHub` in a [public repository](https://github.com/sipbs-compbiol/BM432). You can interact with this repository using `git`, or download the files as a compressed `.zip` archive.

<details>
  <summary>Download a `.zip` file</summary>
